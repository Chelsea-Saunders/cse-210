...
// {
//     public static void startReflectionActivity(int duration)
//     {
...
//         Console.WriteLine(randomPrompt[randomIndex]);
//         Activity.Spinner(5);
...
//         {
//             int reflectionIndex = rand.Next(reflectionPrompt.Length);
//             Console.WriteLine(reflectionPrompt[reflectionIndex]);
